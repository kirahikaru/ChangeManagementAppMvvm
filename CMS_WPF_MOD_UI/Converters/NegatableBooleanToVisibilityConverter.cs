...
namespace ChangeManagementAppModern.Converters
{
    /// <summary>
    /// Custom converter built to convert boolean to visibility
    /// So that we don't have visibility property in the ViewModel and just have a boolean flag
    /// </summary>
